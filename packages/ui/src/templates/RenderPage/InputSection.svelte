<script lang="ts">
  ...
  type Props = {
    ...
    getVersionNameMapping: (version: string) => string;
  ...
  <div class="bg-blue-50 border border-blue-200 rounded-md p-4">
    <p class="text-sm text-blue-800">
      ...
      <span class="font-medium underline">
        <ExtLink
          href="https://github.com/leomotors/chuumai-tools?tab=readme-ov-file#{docsHash}"
        >
          GitHub
        </ExtLink>
      </span>
    ...
    <p class="text-sm text-blue-800">
      ...
      >
        about
      </a> page. This page also includes terms of service and privacy policy, by using
      our service you agree to those terms.
    </p>
  </div>
