...
export interface paths {
  ...
  "/api/calcRating": {
     ...
     * @description Beta: Calculates the player rating based on their best 30 and current 20 songs. Returns processed chart data with ratings.
     */
    post: {
      parameters: {
        query?: never;
  ...
  "/api/users/playHistory": {
     ...
     * @description Returns the user's recorded play history for a specific music ID. Requires authentication via API key or session.
     */
    get: {
      parameters: {
        query: {
