...
> If you don't see any output folders, good luck Windows issue 💀
...
- maimai-web: Web for generating Music for Rating Image but for maimai
- maimai-scraper: Web scraper but for maimai
...
Inspiration of generating image from https://reiwa.f5.si/
