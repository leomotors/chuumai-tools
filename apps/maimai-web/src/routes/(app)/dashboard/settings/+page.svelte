...
<div class="space-y-4">
  ...
  <ManualRatingUploadSection
    ...
    ratingLabel="Rating"
    ratingDescription="Upload a CSV with or without headers. The preview will infer the timestamp and maimai integer rating columns before anything is inserted."
  />
</div>
