<script lang="ts">
  import { CalendarDays, Check, Circle, Hash, RotateCcw } from "@lucide/svelte";
...
>
  <Tabs.Root bind:value={scope} class="gap-4">
    <div class="flex flex-wrap items-start justify-between gap-3">
      ...
      <Tabs.List class="bg-gray-100 text-gray-500">
        <Tabs.Trigger
          value="allTime"
          class="min-w-24 data-[state=active]:bg-white data-[state=active]:text-gray-900"
        >
          All Time
        </Tabs.Trigger>
        <Tabs.Trigger
          value="currentVersion"
          class="min-w-32 data-[state=active]:bg-white data-[state=active]:text-gray-900"
        >
