  ...
  let filteredAndSortedData = $derived.by(() => {
    ...
    result.sort((a, b) => {
      ...
      if (
        ...
        return compareSortableValues(aVal, bVal, sortDirection, descIdSort);
      }
