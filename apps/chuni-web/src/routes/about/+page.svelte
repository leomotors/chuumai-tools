...
>
  <div class="w-full max-w-4xl">
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 space-y-4 mb-4">
      ...
      <p>
        Music Information (such as title, artist, level, jacket image) from
      ...
      <p>
        ...
        </ExtLink> (Old Main Source) + Google Sheet from
        <ExtLink href="https://x.com/CHUNITHM_wiki">Chunithm Wiki</ExtLink>
        +
        <ExtLink href="https://chuni-penguin.beerpsi.cc/developer/api/">
          beer-psi's website
        </ExtLink> (will be new main source) and manual
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 space-y-4 mb-4">
      ...
      <div>
        ...
        <article>
          ...
          <p>
            The Service displays or relies on data from third-party providers.
        ...
        <article>
          <p>
            ...
            including data you upload to the service to improve the service.
            (Not now, but we reserve the rights to do so in the future)
          </p>
          <p>
            When you sign in and upload your data, your information including
            User ID, data that you upload will be saved in the database and
            visible to website's administrators. We reserve rights to look into
            those data and use it to perform analysis to improve the service.
          </p>
        </article>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 space-y-4 mb-4">
      <div class="prose max-w-none">
        <p>
          ...
          or contact me via <ExtLink href="https://x.com/LeomotorsTH">
            X
          </ExtLink>
        </p>
      </div>
    ...
    <div class="bg-white rounded-lg shadow-lg p-6 space-y-4 mb-4">
      <h3 class="font-bold text-lg">Miscellanous</h3>
